...
VALUES (1, 'The Quack Bats'),
  ...
  /* Selecione os três primeiros colocados com a frase inicial " Podium: " e selecione os dois últimos,
  que serão rebaixados para uma liga inferior com a frase inicial " Rebaixado: ". */
  
  SELECT CONCAT('Podium ',team) AS ResultadoFinal FROM league
